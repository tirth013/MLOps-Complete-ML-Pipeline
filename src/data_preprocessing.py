...
def transform_text(text):
    '''
    Transforms input text by converting it to lowercase, tokenizing, removing stopwords and punctuations, and stemming
    '''
    ps = PorterStemmer()
...
def preprocess_df(df, text_column = 'text', target_column = 'target'):
    ...
    try:
        ...
        # Apply text transformation to the specific columns
